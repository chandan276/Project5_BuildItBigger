...
public class JokesAsyncTaskPaid extends AsyncTask<MainActivityFragmentPaid, Void, String> {

    private static MyApi myApiService = null;
    private Context context;

    private MainActivityFragmentPaid mainActivityFragment;

    @Override
    protected String doInBackground(MainActivityFragmentPaid... mainActivityFragments) {
